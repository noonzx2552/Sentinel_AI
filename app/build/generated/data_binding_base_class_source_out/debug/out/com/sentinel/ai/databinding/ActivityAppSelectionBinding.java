...
public final class ActivityAppSelectionBinding implements ViewBinding {
  ...
  private ActivityAppSelectionBinding(@NonNull LinearLayout rootView, @NonNull RecyclerView appList,
      @NonNull Button btnDone, @NonNull TextView tvSubtitle, @NonNull TextView tvTitle) {
  ...
  public static ActivityAppSelectionBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityAppSelectionBinding((LinearLayout) rootView, appList, btnDone, tvSubtitle,
          tvTitle);
    }
