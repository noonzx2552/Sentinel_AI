...
public final class ViewOverlayLiveTranscriptBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public static ViewOverlayLiveTranscriptBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ViewOverlayLiveTranscriptBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.view_overlay_live_transcript, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ViewOverlayLiveTranscriptBinding bind(@NonNull View rootView) {
